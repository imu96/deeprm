...
def launch(pa, pg_resume=None, render=False, repre='image', end='no_new_job'):
    ...
    ref_discount_rews, ref_knap_vals = slow_down_cdf.launch(pa, pg_resume=None, render=False, plot=False, repre=repre, end=end)
